...
class Item2Importer : Tiled2Unity.ICustomTiledImporter
{
        ...
        IDictionary<string, string> props)
    {
        ...
        if (props["spawn"] != "item2")
            return;

        

        // Load the prefab assest and Instantiate it
        string prefabPath = "Assets/Prefabs/Item2.prefab";
        ...
        if (spawn != null)
        {
            ...
            spawnInstance.name = "item2" + id.ToString();
