...
class DisappearingPlatformImporter : Tiled2Unity.ICustomTiledImporter
{
        ...
        IDictionary<string, string> props)
    {
        ...
        if (props["spawn"] != "DisappearingBlock")
            return;

        // Load the prefab assest and Instantiate it
        string prefabPath = "Assets/Prefabs/BreakablePlatform.prefab";
        ...
        if (spawn != null)
        {
            ...
            spawnInstance.name = "Breakable Platform" + id.ToString();
